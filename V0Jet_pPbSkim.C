...
void V0Jet_pPbSkim(TString input_file, TString input_V0file, TString ouputfile, int isMC){
	...
	CasTreeOutput->Branch("Om_d1pt","vector<double>", &Om_d1ptVector);
	CasTreeOutput->Branch("Om_d1eta","vector<double>", &Om_d1etaVector);
	CasTreeOutput->Branch("Om_d1phi","vector<double>", &Om_d1phiVector);
	CasTreeOutput->Branch("Om_d1mass","vector<double>", &Om_d1massVector);
	CasTreeOutput->Branch("Om_chi21_1","vector<double>", &Om_chi21_1Vector);
	CasTreeOutput->Branch("Om_d1pt_1","vector<double>", &Om_d1pt_1Vector);
	CasTreeOutput->Branch("Om_d1eta_1","vector<double>", &Om_d1eta_1Vector);
	CasTreeOutput->Branch("Om_d1phi_1","vector<double>", &Om_d1phi_1Vector);
	CasTreeOutput->Branch("Om_d1mass_1","vector<double>", &Om_d1mass_1Vector);
	CasTreeOutput->Branch("Om_d1Nhit_1","vector<double>", &Om_d1Nhit_1Vector);
	CasTreeOutput->Branch("Om_chi21_2","vector<double>", &Om_chi21_2Vector);
	CasTreeOutput->Branch("Om_d1pt_2","vector<double>", &Om_d1pt_2Vector);
	CasTreeOutput->Branch("Om_d1eta_2","vector<double>", &Om_d1eta_2Vector);
	CasTreeOutput->Branch("Om_d1phi_2","vector<double>", &Om_d1phi_2Vector);
	CasTreeOutput->Branch("Om_d1mass_2","vector<double>", &Om_d1mass_2Vector);
	CasTreeOutput->Branch("Om_d1Nhit_2","vector<double>", &Om_d1Nhit_2Vector);
	CasTreeOutput->Branch("Om_chi22","vector<double>", &Om_chi22Vector);
	CasTreeOutput->Branch("Om_d2pt","vector<double>", &Om_d2ptVector);
	CasTreeOutput->Branch("Om_d2eta","vector<double>", &Om_d2etaVector);
	CasTreeOutput->Branch("Om_d2phi","vector<double>", &Om_d2phiVector);
	CasTreeOutput->Branch("Om_d2mass","vector<double>", &Om_d2massVector);
	CasTreeOutput->Branch("Om_d2Nhit","vector<double>", &Om_d2NhitVector);
	CasTreeOutput->Branch("Om_cas3DIpSigValue","vector<double>", &Om_cas3DIpSigValueVector);
	CasTreeOutput->Branch("Om_casPi3DIpSigValue","vector<double>", &Om_casPi3DIpSigValueVector);
	CasTreeOutput->Branch("Om_VTrkPi3DIpSigValue","vector<double>", &Om_VTrkPi3DIpSigValueVector);
	CasTreeOutput->Branch("Om_VTrkP3DIpSigValue","vector<double>", &Om_VTrkP3DIpSigValueVector);
	CasTreeOutput->Branch("Om_casFlightSigValue","vector<double>", &Om_casFlightSigValueVector);
	CasTreeOutput->Branch("Om_distanceSigValue","vector<double>", &Om_distanceSigValueVector);
	CasTreeOutput->Branch("Om_pt","vector<double>", &Om_ptVector);
	CasTreeOutput->Branch("Om_eta","vector<double>", &Om_etaVector);
	CasTreeOutput->Branch("Om_phi","vector<double>", &Om_phiVector);
	CasTreeOutput->Branch("Om_mass","vector<double>", &Om_massVector);
	CasTreeOutput->Branch("Om_id","vector<double>", &Om_idVector);
